{
  ...
  connection: {
    fields: [
      { name: 'login_username', control_type: 'text', optional: false },
        ...
        [{ name: 'RECORDNO', label: 'Record number', type: 'integer' },
         {
           name: 'EMPLOYEEID',
           label: 'Employee ID',
           hint: 'The employee ID to create. Required if company does not use auto-numbering.',
           sticky: true
         },
         {
           name: 'PERSONALINFO',
         ...
         {
           name: 'STATUS',
           hint: 'Use active for Active otherwise use inactive for Inactive (Default: active)',
           control_type: 'select',
           pick_list: 'statuses',
         ...
         { name: 'DEPARTMENTID', label: 'Department ID' },
         {
           name: 'LOCATIONID',
           label: 'Location ID',
           hint: 'Location ID. Required only when an employee is created at the top level in a multi-entity, multi-base-currency company.',
           sticky: true
         },
        ...
        [{ name: 'RECORDNO', label: 'Record number', type: 'integer' },
         ...
         },
         {
           ...
           properties: [
             ...
             {
               name: 'TAXABLE',
               hint: 'Taxable. Use false for No, true for Yes. (Default: true)', control_type: 'checkbox',
               type: 'boolean'
             },
             ...
             {
               name: 'STATUS',
               hint: 'Status. Use active for Active or inactivefor Inactive (Default: active)'
             },
             {
               name: 'MAILADDRESS',
               type: 'object',
            ...
            properties: [
              {
                ...
                properties: [
                  ...
                  { name: 'warehouseid' },
                  { name: 'quantity' },
                  { name: 'unit', hint: 'Unit of measure to base quantity off' },
                  { name: 'price' },
                  {
                    name: 'sourcelinekey',
                  ...
                  {
                    name: 'form1099',
                    hint: 'Form 1099. Use false for No, truefor Yes. Vendor must be set up for 1099s.',
                    control_type: 'checkbox',
                    type: 'boolean'
                  },
                  {
                  ...
                  {
                    name: 'billable',
                    hint: 'Billable. Use false for No, true for Yes. (Default: false)',
                    control_type: 'checkbox',
                    type: 'boolean'
                  }
                ]
  ...
  actions: {
    ...
    create_attachments: {
      ...
      description: "Create <span class='provider'>attachments</span> in <span class='provider'>Intacct</span>",

      input_fields: lambda { |object_definitions|
        object_definitions['supdoc']
          .ignored('creationdate', 'createdby', 'lastmodified', 'lastmodifiedby')
    ...
    get_attachment: {
      ...
      description: "Get <span class='provider'>attachment</span> in <span class='provider'>Intacct</span>",
    ...
    get_attachment_folder: {
      ...
      description: "Get <span class='provider'>attachment_folder</span> in <span class='provider'>Intacct</span>",
      ...
      output_fields: lambda { |object_definitions|
        object_definitions['supdocfolder']
          .ignored('supdocfoldername', 'supdocfolderdescription', 'supdocparentfoldername')
      }
    },

    update_attachment_folder: {
      subtitle: 'Create attachment folder',
      description: "Create <span class='provider'>attachment folder</span> in <span class='provider'>Intacct</span>",

      input_fields: lambda { |object_definitions|
        # fix for the conflict in fields for get and update_supdocfolder calls
        object_definitions['supdocfolder']
          .ignored('creationdate', 'createdby', 'lastmodified', 'lastmodifiedby')
          .ignored('name', 'description', 'parentfolder')
          .required('supdocfoldername')
    ...
    get_api_session: {
      ...
      description: "Get <span class='provider'>API session</span> in <span class='provider'>Intacct</span>",
    ...
    create_employee: {
      ...
      description: "Create <span class='provider'>employee</span> in <span class='provider'>Intacct</span>",
    ...
    get_employee: {
      ...
      description: "Get <span class='provider'>employee</span> in <span class='provider'>Intacct</span>",
    ...
    update_employee: {
      ...
      description: "Update <span class='provider'>employee</span> in <span class='provider'>Intacct</span>",
      ...
      execute: lambda { |_connection, input|
        ...
        (post('/ia/xml/xmlgw.phtml')
                   ...
                   .dig('response', 0,
                        'operation', 0,
                        'result', 0) || {})
          .map { |key, value| { key => value.dig(0, 'content!') } }
          .inject(:merge)
      },

      output_fields: lambda { |object_definitions|
        object_definitions['result']
      }
    },
    ...
    update_purchase_transaction_header: {
      ...
      description: "Update <span class='provider'>purchase transaction header</span> in <span class='provider'>Intacct</span>",
      help: 'Pay special attention to map the data pills in the same order as you see in the input list, for the action to be successful!',

      input_fields: lambda { |object_definitions|
        object_definitions['po_txn_header']
          .required('@key')
      },
    ...
    add_purchase_transaction_items: {
      ...
      description: "Add <span class='provider'>purchase transaction items</span> in <span class='provider'>Intacct</span>",
      help: 'Pay special attention to map the data pills in the same order as you see in the input list, for the action to be successful!',
    ...
    update_purchase_transaction_items: {
      ...
      description: "Update <span class='provider'>purchase transaction items</span> in <span class='provider'>Intacct</span>",
      help: 'Pay special attention to map the data pills in the same order as you see in the input list, for the action to be successful!',
