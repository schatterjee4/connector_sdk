  ...
  connection: {
    fields: [
      { name: "host", control_type: :subdomain, url: ".com", optional: false,
        hint: "If your Coupa URL is https://acme.coupacloud.com, "\
              "then use acme.coupacloud as value." },
      { name: "api_key", control_type: :password, label: "API key",
        hint: "A key can be created from the “API Keys” section of the "\
              "Administration tab by an admin user." }
    ],
    ...
    user_input: {
      fields: ->() {
        [
          ...
          { name: "account_security_type", label: "Account security type",
            type: :integer },
          ...
          { name: "business_group_security_type", label: "Business group security type",
            type: :integer },
          { name: "edit_invoice_on_quick_entry", label: "Edit invoice on quick entry?",
            type: :boolean },
          ...
          { name: "default_address", label: "Default address", type: :object,
            ...
            properties: [
              ...
              { name: "content_groups", label: "Content groups",
                type: :array, of: :object, properties: [
                  { name: "id", label: "Content group", control_type: :multiselect,
                    pick_list: "content_groups" },
                ] },
          ] },
          { name: "default_account", label: "Default account", type: :object,
            properties: [
              { name: "id", label: "Account", control_type: :select,
                pick_list: "accounts", toggle_hint: "Select from list",
                toggle_field: {
                  name: "id", type: :string, control_type: :text,
                  label: "Account ID", toggle_hint: "Use custom value"
              } },
            ] },
          { name: "default_account_type", label: "Default account type",
            type: :object, properties: [
              { name: "id", label: "Account type", control_type: :select,
                pick_list: "account_types", toggle_hint: "Select from list",
                toggle_field: {
                  name: "id", type: :string, control_type: :text,
                  label: "Account type ID", toggle_hint: "Use custom value"
              } },
            ] },
          { name: "default_currency", label: "Default currency", type: :object,
            properties: [
              { name: "id", label: "Currency", control_type: :select,
                pick_list: "currencies", toggle_hint: "Select from list",
                toggle_field: {
                  name: "id", type: :string, control_type: :text,
          ...
          { name: "department", type: :object, properties: [
            { name: "id", label: "Department", control_type: :select,
              pick_list: "departments", toggle_hint: "Select from list",
              toggle_field: {
                name: "id", type: :string, control_type: :text,
                label: "Department ID", toggle_hint: "Use custom value"
              } },
            ] },
          { name: "requisition_approval_limit", label: "Requisition approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "expense_approval_limit", label: "Expense approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "invoice_approval_limit", label: "Invoice approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "requisition_self_approval_limit", label: "Requisition self-approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "expense_self_approval_limit", label: "Expense self-approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "invoice_self_approval_limit", label: "Invoice self-approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "approval_limit", label: "Approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "self_approval_limit", label: "Self-approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "contract_approval_limit", label: "Contract approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "contract_self_approval_limit", label: "Contract self-approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "content_groups", label: "Content groups", type: :array, of: :object,
            properties: [
              { name: "id", label: "Content group", control_type: :multiselect,
                pick_list: "content_groups" }
            ] },
          { name: "account_groups", label: "Account groups", type: :array, of: :object,
            properties: [
              { name: "id", label: "ID", type: :integer }
            ] },
          { name: "approval_groups", label: "Approval groups", type: :array, of: :object,
            properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "user_groups", label: "User groups", type: :array, of: :object,
            properties: [
              { name: "id", label: "User group", control_type: :multiselect,
                pick_list: "user_groups" }
            ] },
          { name: "working_warehouses", label: "Working warehouses",
            type: :array, of: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
          { name: "inventory_organizations", label: "Inventory organizations",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
            ] },
        ]
    ...
    user_output: {
      fields: ->() {
        [
          ...
          { name: "login" },
          { name: "email" },
          { name: "purchasing-user", label: "Purchasing user?",
            control_type: :checkbox, type: :boolean },
          { name: "expense-user", label: "Expense user?",
            control_type: :checkbox, type: :boolean },
          { name: "sourcing-user", label: "Sourcing user?",
            control_type: :checkbox, type: :boolean },
          { name: "inventory-user", label: "Inventory user?",
            control_type: :checkbox, type: :boolean },
          { name: "contracts-user", label: "Contracts user?",
            control_type: :checkbox, type: :boolean },
          { name: "analytics-user", label: "Analytics user?",
            control_type: :checkbox, type: :boolean },
          ...
          { name: "account-security-type", label: "Account security type",
            type: :integer },
          ...
          { name: "business-group-security-type", label: "Business group security type",
            type: :integer },
          { name: "edit-invoice-on-quick-entry", label: "Edit invoice on quick entry?",
            type: :boolean },
          ...
          { name: "default-address", label: "Default address", type: :object,
            properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              ...
              { name: "content-groups", label: "Content groups",
                type: :array, of: :object, properties: [
                  { name: "id", label: "ID", type: :integer },
                  { name: "name" },
                  { name: "description" }
          ...
          { name: "default-account", label: "Default account", type: :object,
            properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "code" },
              ...
              { name: "account-type", type: :object, properties: [
                ...
                { name: "primary-address", label: "Primary address",
                  type: :object, properties: [
                    { name: "id", label: "ID", type: :integer },
                    { name: "name" },
                    { name: "location-code", label: "Location code" },
          ...
          { name: "default-account-type", label: "Default account type",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "active", label: "Active?", type: :boolean },
          ...
          { name: "default-currency", label: "Default currency",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "code" },
              { name: "decimals", type: :integer },
          ...
          { name: "requisition-approval-limit", label: "Requisition approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "amount" },
          ...
          { name: "expense-approval-limit", label: "Expense approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "amount" },
          ...
          { name: "invoice-approval-limit", label: "Invoice approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "amount" },
          ...
          { name: "requisition-self-approval-limit", label: "Requisition self-approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "amount" },
          ...
          { name: "expense-self-approval-limit", label: "Expense self-approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "amount" },
          ...
          { name: "contract-approval-limit", label: "Contract approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "amount" },
          ...
          { name: "contract-self-approval-limit", label: "Contract self-approval limit",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "amount" },
          ...
          { name: "content-groups", label: "Content groups", type: :array, of: :object,
            properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "description" }
          ...
          { name: "approval-groups", label: "Approval groups",
            type: :array, of: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "active", label: "Active?", type: :boolean },
          ...
          { name: "user-groups", label: "User groups", type: :array, of: :object,
            properties: [
              { name: "id", label: "ID", type: :integer },
              { name: "name" },
              { name: "active", label: "Active?", type: :boolean },
          ...
          { name: "working-warehouses", label: "Working warehouses",
            type: :array, of: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              ...
              { name: "asset-tracking-location", label: "Asset tracking location",
                type: :boolean },
              { name: "warehouse-type", label: "Warehouses type", type: :object,
                properties: [
                  { name: "id", label: "ID", type: :integer },
                  { name: "description" },
                  { name: "name" },
                ] },
              { name: "warehouse-locations", label: "Warehouse locations",
                type: :object, properties: [
                  { name: "id", label: "ID", type: :integer },
                  { name: "aisle" },
                  { name: "bin" },
          ...
          { name: "inventory-organizations", label: "Inventory organizations",
            type: :object, properties: [
              { name: "id", label: "ID", type: :integer },
              ...
              { name: "warehouses", label: "Warehouses", type: :array, of: :object,
                properties: [
                  { name: "id", label: "ID", type: :integer },
                  { name: "active-flag", label: "Active flag", type: :boolean },
                  { name: "description" },
